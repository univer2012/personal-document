...
#import "SGHPushTwoViewController.h"
...
-(void)opDemo6 {
    ...
    SGHPushCodeViewController *controller = [SGHPushCodeViewController new];
    [self.navigationController pushViewController:controller animated:YES];
#if 0
    SGHPushTwoViewController *controller = [SGHPushTwoViewController new];
    [self.navigationController pushViewController:controller animated:YES];
#endif
#if 0
