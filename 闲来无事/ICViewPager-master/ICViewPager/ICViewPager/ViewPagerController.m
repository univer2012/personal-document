...
- (void)viewWillLayoutSubviews {
    ...
    frame.size.width = self.view.bounds.size.width; //- 100; //这里设置 小模块列表的 宽
...
- (IBAction)handleTapGesture:(id)sender {
    ...
    if (index < self.activeTabIndex) {
        [self.pageViewController setViewControllers:@[viewController] direction: UIPageViewControllerNavigationDirectionReverse animated:YES
