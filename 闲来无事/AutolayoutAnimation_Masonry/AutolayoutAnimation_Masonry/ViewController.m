...
-(void)p_setUpViews {
    ...
    UIImageView *phoneIconImageView=({
        ...
        imageView.image =[UIImage imageNamed:@"mobile_icon"];
        ...
        [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.equalTo(imageView.mas_height).multipliedBy(imageView.image.size.width/imageView.image.size.height);
        }];
